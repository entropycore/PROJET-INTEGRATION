...
router.get('/validations/pending', administratorController.listPendingValidationItems);
router.get('/validations/pending-count', administratorController.getPendingValidationsCount);
router.get('/validations/:validationId', administratorController.getValidationItemById);
router.patch('/validations/:validationId/approve', administratorController.approveValidationItemById);
router.patch('/validations/:validationId/reject', administratorController.rejectValidationItemById);
router.patch('/validations/:validationId/request-changes', administratorController.requestValidationChangesById);
...
router.get('/reports/pending-count', administratorController.getPendingReportsCount);
router.get('/reports/:reportId', administratorController.getReportById);
router.patch('/reports/:reportId/resolve', administratorController.resolveReport);
...
router.delete('/reports/:reportId/target', administratorController.deleteReportedTarget);

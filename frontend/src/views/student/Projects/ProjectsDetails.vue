...
<template>
  <section class="project-details-page">
    <div v-if="isLoading" class="details-state">Chargement du projet...</div>
    ...
    <template v-else-if="project">
      <div class="project-details-header">
        <div class="project-header-left">
          ...
          <p
            v-else-if="project.validationStatus === 'PENDING'"
          ...
          <p
            v-else-if="project.validationStatus === 'CHANGES_REQUESTED'"
            class="project-header-validator pending"
          >
            ...
            <div class="timeline-list">
              ...
              >
                ...
                <div class="timeline-content">
                  ...
                  <small> {{ item.actorName }} — {{ item.actorRole }} </small>
                </div>
              </div>
              <p
                v-if="!sortedValidationHistory.length"
                class="empty-section-message"
              >
        ...
        <aside class="project-sidebar">
          ...
          >
            <div class="delete-project-content">
              ...
              <p>
                Cette action est irréversible. Le projet, les captures d’écran
                et les pièces jointes seront supprimés.
              </p>

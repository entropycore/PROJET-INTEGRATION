  ...
  <section class="admin-user-details-page">
      ...
      <div class="details-grid">
        ...
        <section class="details-card">
          ...
          <div v-if="user.role === 'STUDENT'" class="form-grid">
            ...
            /></label>
            <label
              >Apogée <input v-model="form.apogeeCode" :disabled="!isEditMode"
            /></label>
            <label
              >CNE <input v-model="form.cne" :disabled="!isEditMode"
            /></label>
            <label
              >Ville <input v-model="form.city" :disabled="!isEditMode"
            /></label>
            <label
              >LinkedIn
              <input v-model="form.linkedinUrl" :disabled="!isEditMode"
            /></label>
          </div>
          ...
          <div v-else-if="user.role === 'PROFESSOR'" class="form-grid">
            <label
              >Employee ID
              <input v-model="form.employeeId" :disabled="!isEditMode"
            /></label>
            <label
          ...
          <div v-else-if="user.role === 'PROFESSIONAL'" class="form-grid">
            <label
              >Entreprise <input v-model="form.company" :disabled="!isEditMode"
            /></label>
            <label
              >Poste <input v-model="form.jobTitle" :disabled="!isEditMode"
            /></label>
            <label
              >Secteur <input v-model="form.sector" :disabled="!isEditMode"
            /></label>
            <label class="full-width"
              >Bio <textarea v-model="form.bio" :disabled="!isEditMode" />
            </label>
          </div>
          ...
          <div v-else-if="user.role === 'ADMINISTRATOR'" class="form-grid">
            ...
            <label
              >Niveau admin
              <input v-model="form.adminLevel" :disabled="!isEditMode"
            /></label>
          </div>
        </section>
    ...
    <div v-if="temporaryPassword" class="admin-modal-backdrop">
      <section class="admin-modal">
        ...
        <p class="admin-modal-text">Mot de passe temporaire généré :</p>
